...
function MagneticCTA({
  ...
  return (
    <a
      ...
      className="inline-flex h-10 items-center justify-center rounded-full bg-[var(--accent)] px-5 text-sm font-medium text-[var(--accent-ink)] shadow-[0_8px_24px_-12px_rgba(255,140,0,0.4)] transition-[transform,background-color] duration-300 hover:bg-[#FFA31A] will-change-transform"
    >
      {children}
    </a>
  );
