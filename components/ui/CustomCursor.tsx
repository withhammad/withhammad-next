  ...
  return (
    <>
      <div
        ref={dotRef}
        aria-hidden
        className="pointer-events-none fixed left-0 top-0 z-[9999] h-1.5 w-1.5 rounded-full bg-[var(--accent-amber)]"
      />
      <div
        ref={ringRef}
        aria-hidden
        ...
        style={{
          backgroundColor: hovering
            ? "color-mix(in oklab, var(--accent-indigo) 18%, transparent)"
            : "transparent",
