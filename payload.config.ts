...
// project was purged.
// `||` throughout: blank env vars are "" and must be treated as unset.
...
export default buildConfig({
  ...
  // `||` not `??`: a blank env var is "" (present but empty), which ?? would
  // happily pass through and Payload rejects as a missing secret.
      ...
      for (const p of BLOG_SEED) {
        ...
        await payload.create({
          ...
          data: {
            ...
            // Explicit: enabling drafts makes _status meaningful, and seeded
            // posts are real published content, not drafts.
            _status: "published",
          },
        });
        seeded += 1;
  ...
  collections: [
    ...
    // ---- Blog Posts ----
    {
      ...
      // Drafts are the approval gate for the AI pipeline: `npm run draft`
      // writes _status: "draft", and nothing reaches the site until a human
      ...
      fields: [
        ...
        { name: "publishedDate", type: "date" },
        {
          ...
          admin: {
            description:
              "Primary keyword this post targets, e.g. 'AI marketing automation Dubai'.",
            position: "sidebar",
          },
        },
        {
          ...
          defaultValue: false,
          admin: {
            description: "Generated by `npm run draft`. Review before publishing.",
            position: "sidebar",
          },
        },
        {
          ...
          type: "textarea",
          admin: {
            description: "The brief this draft was generated from.",
            position: "sidebar",
          },
        },
